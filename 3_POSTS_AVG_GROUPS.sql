--сREATE TABLE IF NOT EXISTS AVG_OWNER_NAME 
SELECT
	OWNER_NAME,
	UNITYPE, 
	AREA,
	...
	AVG(PER_COM_EXCLAMATION) AS AVG_PER_COM_EXCLAMATION
	...
	--ROUND(AVG(AVG_NEUTRALITY, 3) AS AVG_NEUTRAL_COM
	--TIME(ROUND(AVG(AVG_TIME_POST, 3) AS AVG_TIME_POST)
FROM
	excel
GROUP BY 
	OWNER_NAME;